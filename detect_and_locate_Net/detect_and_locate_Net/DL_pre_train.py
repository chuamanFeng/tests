...
parser.add_argument('--max_epoch', type=int, default=200, help='Epoch to run [default: 150]')
...
save_dir='H:'
data_dir='H:\DLtrue\A'   #HERE WE GONNA USE TFRecords
data_dir_vali='H:\DLtrue\B'
data_dir_test='H:\DLtrue\C'
   ...
   C part
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope('scalars'):
            ...
            pred= MODEL.brute_classify(img_pl,CLASS_NUM,is_training_pl,bn_decay=bn_decay)
