...
parser.add_argument('--log_dir', default='H:\Roidata', help='Log dir [default: log]')
parser.add_argument('--stan_size', default=[224,224], help='lenth&width for croping&resizing')
parser.add_argument('--scales', default=[0.3,0.3,0.4], help='for loss_calc,[class,object,ant_object,coord]')
...
#save_dir='H:\DLtest\B'
data_dir='H:\Roidata\A'   #HERE WE GONNA USE TFRecords
data_dir_test='H:\Roidata\C'
data_dir_vali='H:\Roidata\B'
