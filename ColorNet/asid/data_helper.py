...
def shuffle_it_sin(input,b=None):
     ...
     return input[idx]
 #def pre_process_before_training(data_list,crop=True,crop_round=CROP_ROUND,crop_size=CROP_SIZE,crop_list=ORIGIN_CROP_LIST,start_or_idx=0,or_num=None):

#       out,end_idx=hp.pre_process_before_training(data_list,crop=crop,crop_size=crop_size,crop_round=crop_round,crop_origin_list=crop_list,start_or_idx=start_or_idx,or_num=or_num)
